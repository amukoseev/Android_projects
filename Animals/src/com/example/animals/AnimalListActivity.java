 ...
 */
public class AnimalListActivity extends FragmentActivity implements
		AnimalListFragment.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.animal_detail_container) != null) {
			...
			((AnimalListFragment) getSupportFragmentManager().findFragmentById(
					R.id.animal_list)).setActivateOnItemClick(true);
		}
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			getSupportFragmentManager().beginTransaction()
					.replace(R.id.animal_detail_container, fragment).commit();
